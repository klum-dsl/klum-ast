...
This is a compact index for later issue analysis. Unless marked **target** or **hypothesis**, statements below are confirmed
by source and tests on `master` at `8efa2005` (2026-07-20), with the Builder-capability seam reconciled through merged PR
#782 and BQ-5 evidence on 2026-09-21. Reopen source when an issue touches an unmapped seam or contradicts this map.
...
|---|---|---|---|
| `klum-ast-annotations` | Public schema vocabulary: `@DSL`, field/key/owner/role, lifecycle, validation, converter, copy strategy, Layer 3 annotations, and the nested `Builder.Method`/`Query`/`Input`/`Result` capability vocabulary. Runtime retention supports generated-contract inspection; transformation/validator classes are named as strings so the annotation artifact does not depend on compiler implementation. | AnnoDocimal annotations and KlumCast annotations; Groovy is compile-only. | [`DSL.java`](../../../klum-ast-annotations/src/main/java/com/blackbuild/groovy/configdsl/transform/DSL.java), [`Builder.java`](../../../klum-ast-annotations/src/main/java/com/blackbuild/klum/ast/Builder.java), [`Field.java`](../../../klum-ast-annotations/src/main/java/com/blackbuild/groovy/configdsl/transform/Field.java), [`FieldType.java`](../../../klum-ast-annotations/src/main/java/com/blackbuild/groovy/configdsl/transform/FieldType.java), [`layer3/annotations`](../../../klum-ast-annotations/src/main/java/com/blackbuild/klum/ast/util/layer3/annotations) |
| `klum-ast` | Compile-time implementation. Local AST transformations validate schemas, move construction state and Builder-only methods to hidden generated Builders, project explicitly selected queries and input/result positions, generate factories/DSL methods and the public `Foo_DSL` support contract, and emit internal materialization hooks. It is consumed for schema compilation, not normal model runtime. | `api`: annotations, runtime, AnnoDocimal global AST, KlumCast compiler. | [`DSLASTTransformation.java`](../../../klum-ast/src/main/java/com/blackbuild/klum/ast/compiler/internal/ast/DSLASTTransformation.java), [`BuilderMethodProjection.java`](../../../klum-ast/src/main/java/com/blackbuild/klum/ast/compiler/internal/ast/BuilderMethodProjection.java), [`BuilderQuerySupport.java`](../../../klum-ast/src/main/java/com/blackbuild/klum/ast/compiler/internal/ast/BuilderQuerySupport.java), [`GeneratedDslSupport.java`](../../../klum-ast/src/main/java/com/blackbuild/klum/ast/compiler/internal/ast/GeneratedDslSupport.java), [`ConverterBuilder.java`](../../../klum-ast/src/main/java/com/blackbuild/klum/ast/compiler/internal/ast/ConverterBuilder.java) |
| `klum-ast-runtime` | Runtime deep module behind generated methods: root factories, Builder state, typed factory-token predicates/narrowing, phase driver, materialization, templates/copying, validation, construction/structural paths, owner/link/default phases, and structure traversal. Generated schema bytecode names the exported, generated-only bridges for Builder/state, Template, and breadcrumbs; their internal delegates remain implementation vocabulary. `BreadcrumbCollector` remains generated/runtime implementation vocabulary. | `api`: annotations. Phase actions and validators are extended through Java `ServiceLoader`. | [`GeneratedBuilderTypeSupport.java`](../../../klum-ast-runtime/src/main/java/com/blackbuild/klum/ast/runtime/generated/GeneratedBuilderTypeSupport.java), [`GeneratedBreadcrumbs.java`](../../../klum-ast-runtime/src/main/java/com/blackbuild/klum/ast/runtime/generated/GeneratedBreadcrumbs.java), [`KlumBuilder.java`](../../../klum-ast-runtime/src/main/java/com/blackbuild/klum/ast/util/KlumBuilder.java), [`FactoryHelper.java`](../../../klum-ast-runtime/src/main/java/com/blackbuild/klum/ast/util/FactoryHelper.java), [`PhaseDriver.java`](../../../klum-ast-runtime/src/main/java/com/blackbuild/klum/ast/process/PhaseDriver.java) |
...
- explicit `@Builder.Query` and `@Builder.Method` operations plus `@Builder.Input`/`@Builder.Result` positions on public
  Builder contracts, while unselected Model methods and positions retain completed-state semantics;
...
- Transformation/generated interface: [`TransformSpec.groovy`](../../../klum-ast/src/test/groovy/com/blackbuild/groovy/configdsl/transform/TransformSpec.groovy), [`GeneratedDslSupportSpec.groovy`](../../../klum-ast/src/test/groovy/com/blackbuild/klum/ast/compiler/internal/ast/GeneratedDslSupportSpec.groovy), [`BuilderMethodTest.groovy`](../../../klum-ast/src/test/groovy/com/blackbuild/klum/ast/BuilderMethodTest.groovy), [`BuilderQueryTest.groovy`](../../../klum-ast/src/test/groovy/com/blackbuild/groovy/configdsl/transform/BuilderQueryTest.groovy), [`BuilderTypeNarrowingTest.groovy`](../../../klum-ast/src/test/groovy/com/blackbuild/groovy/configdsl/transform/BuilderTypeNarrowingTest.groovy), [`BuilderInputResultProjectionTest.groovy`](../../../klum-ast/src/test/groovy/com/blackbuild/groovy/configdsl/transform/BuilderInputResultProjectionTest.groovy), and [`SharedCapabilitiesDocumentaryTest.groovy`](../../../klum-ast/src/test/groovy/com/blackbuild/groovy/configdsl/transform/SharedCapabilitiesDocumentaryTest.groovy).
...
- [ADR 0020](../../adr/0020-explicit-shared-model-builder-capabilities.md) accepts and implements explicit shared

...
- Generated `Foo_DSL` AST layout (#394) remains decided but not implemented. Jackson JSON-1/#439 and JSON-2/#440 are
  implemented; #428 retains final compatibility closure. Completed-object support (#390) has its OS-1 provenance/structure
  slice implemented; OS-2 validation and proxy-lockdown

...
| #431, #467, #468, #474 | All touch the Builder-first public boundary, but their ownership is intentionally separate: #431 owns `AsBuilder`/composition protocol completion; #474 owns Layer 3 `OPTIONAL_LINK`, per-entry relationship semantics, and generated relationship calls; #467 names only framework-owned entrypoints such as dynamic `KlumBuilder.link`; and #468 inventories/freezes the resulting JVM-public members. |

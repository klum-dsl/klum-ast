...
| #142, #251, #358, #428 | #142 is generic annotation injection; #251 is Jackson property-name binding; #358 is the now-implemented Builder deserializer; #428 is lifecycle persistence policy. The modern Jackson module makes the old Jackson-specific motivation of #142 obsolete without resolving generic annotation injection. |
...
| #251, #358, #428 | #358's implementation can close while #251 mapping and #428 lifecycle policy remain open. The current raw-map deserializer is direct evidence of that separation. |

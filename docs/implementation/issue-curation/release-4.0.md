...
| #431 — finalized ADR 0004 | Implemented: active sessions, adaptable composition, Template/copy/scheduling boundaries, and the final public compatibility reconciliation are complete. | [#436 AB-1](https://github.com/klum-dsl/klum-ast/issues/436), [#437 AB-2](https://github.com/klum-dsl/klum-ast/issues/437), [#438 AB-3](https://github.com/klum-dsl/klum-ast/issues/438), focused lifecycle/projection/copy/phase tests, Java and `@CompileStatic` consumer compilation, migration/wiki/CHANGES, and Groovy 3/4/5 validation. | #474 independently owns Layer 3 relationship modes; #431 owns the active-session/`AsBuilder` protocol and does not absorb that work. |
| #474 — Layer 3 composition-or-aggregation relationships | Implemented by PR #506: Layer 3 `@LinkTo` preserves either a local composition override or aggregation fallback. | `OPTIONAL_LINK`, Builder composition claims, per-entry collection/map semantics, generated Java/Groovy relationship API, non-destructive dynamic Auto-Link fallback, rejection/migration coverage, ADR 0003/0004 clarification, and wiki/CHANGES evidence on Groovy 3/4/5. | #431 remains the active-session/`AsBuilder` protocol; #467 classifies the dynamic framework capability; #468 inventories and freezes the final generated surface. |

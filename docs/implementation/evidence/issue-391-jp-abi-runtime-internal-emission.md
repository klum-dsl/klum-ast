...
JP-ABI-1, JP-ABI-2, JP-ABI-3, JP-ABI-4, and this JP-ABI-5 Cluster slice
migrate the Builder, model-state, Materialization, Template, breadcrumb, and
Cluster entries below to the generated-runtime bridge. The named-module tracer
must regenerate the full representative output after the remaining
omitted-projection entry is migrated.

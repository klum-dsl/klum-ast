...
JP-ABI-1, JP-ABI-2, and JP-ABI-3 migrate the Builder, model-state, and
Materialization entries below to the generated-runtime bridge. The named-module
tracer must regenerate the full representative output after the remaining
breadcrumb, Cluster, omitted-projection, and Template entries are migrated.

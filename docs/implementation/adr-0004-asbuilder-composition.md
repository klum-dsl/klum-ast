...
| [`DSLASTTransformation`](../../klum-ast/src/main/java/com/blackbuild/klum/ast/compiler/internal/ast/DSLASTTransformation.java), lines 947–953 and 1147–1153 | The generated direct collection/map overloads accept `Class<? extends Script>...` and route to the broken runtime helpers. |
| [`ConverterBuilder.createConverterMethod`](../../klum-ast/src/main/java/com/blackbuild/klum/ast/compiler/internal/ast/ConverterBuilder.java), lines 216–276 | Generated converter methods preserve the model return type and invoke runtime setter/adder converter paths; they have no Builder-producing adaptation. |

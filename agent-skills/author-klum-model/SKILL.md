...
Read the matching [Basics](https://klum-dsl.github.io/klum-ast/4.0/Basics/), [Validation](https://klum-dsl.github.io/klum-ast/4.0/Validation/), [Default Values](https://klum-dsl.github.io/klum-ast/4.0/Default-Values/), and [Builder-first migration](https://klum-dsl.github.io/klum-ast/4.0/Builder-First-Migration/) guidance before changing a lifecycle or construction boundary.

...
Read the matching [Basics](https://github.com/klum-dsl/klum-ast/wiki/Basics), [Validation](https://github.com/klum-dsl/klum-ast/wiki/Validation), [Default Values](https://github.com/klum-dsl/klum-ast/wiki/Default-Values), and [Builder-first migration](https://github.com/klum-dsl/klum-ast/wiki/Builder-First-Migration) guidance before changing a lifecycle or construction boundary.

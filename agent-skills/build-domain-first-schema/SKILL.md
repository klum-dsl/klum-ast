...
For the authoritative concepts, read [Getting Started](https://klum-dsl.github.io/klum-ast/4.0.0/Getting-Started/#choose-the-model-shape-first), [Layer 3](https://klum-dsl.github.io/klum-ast/4.0.0/Layer3/), [Basics](https://klum-dsl.github.io/klum-ast/4.0.0/Basics/), [Validation](https://klum-dsl.github.io/klum-ast/4.0.0/Validation/), and [Builder-first migration](https://klum-dsl.github.io/klum-ast/4.0.0/Builder-First-Migration/). Issue [#454](https://github.com/klum-dsl/klum-ast/issues/454) owns unresolved Layer 3 terminology and policy; capture a newly exposed contract question for maintainer review instead of letting this example decide it.

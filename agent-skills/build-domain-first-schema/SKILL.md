...
For the authoritative concepts, read [Getting Started](https://github.com/klum-dsl/klum-ast/wiki/Getting-Started#choose-the-model-shape-first), [Layer 3](https://github.com/klum-dsl/klum-ast/wiki/Layer3), [Basics](https://github.com/klum-dsl/klum-ast/wiki/Basics), [Validation](https://github.com/klum-dsl/klum-ast/wiki/Validation), and [Builder-first migration](https://github.com/klum-dsl/klum-ast/wiki/Builder-First-Migration). Issue [#454](https://github.com/klum-dsl/klum-ast/issues/454) owns unresolved Layer 3 terminology and policy; capture a newly exposed contract question for maintainer review instead of letting this example decide it.

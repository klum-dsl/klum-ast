...
See [Target Contract Modeling](https://klum-dsl.github.io/klum-ast/4.0.0/Target-Contract-Modeling/) for the task guide and [`../../field-tests/target-contract-helm/`](../../field-tests/target-contract-helm/) for the later real-project evaluation starting point.

...
8. For AnnoDoc Support for IntelliJ IDEA publication and installation status, follow the current [Gradle onboarding guidance](https://klum-dsl.github.io/klum-ast/4.0/Getting-Started/#intellij-and-generated-dsl-support). Do not claim Marketplace availability without checking that source. Other IDEs should use normal Gradle import and compilation; this skill makes no parity claim.

Read the matching [Gradle Plugins](https://klum-dsl.github.io/klum-ast/4.0/Gradle-Plugins/), [Basics](https://klum-dsl.github.io/klum-ast/4.0/Basics/), [Layer 3](https://klum-dsl.github.io/klum-ast/4.0/Layer3/), and [Builder-first migration](https://klum-dsl.github.io/klum-ast/4.0/Builder-First-Migration/) guidance before resolving a design question.

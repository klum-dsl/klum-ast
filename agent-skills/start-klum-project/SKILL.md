...
8. For AnnoDoc Support for IntelliJ IDEA publication and installation status, follow the current [Gradle onboarding guidance](https://github.com/klum-dsl/klum-ast/wiki/Getting-Started#intellij-and-generated-dsl-support). Do not claim Marketplace availability without checking that source. Other IDEs should use normal Gradle import and compilation; this skill makes no parity claim.

Read the matching [Gradle Plugins](https://github.com/klum-dsl/klum-ast/wiki/Gradle-Plugins), [Basics](https://github.com/klum-dsl/klum-ast/wiki/Basics), [Layer 3](https://github.com/klum-dsl/klum-ast/wiki/Layer3), and [Builder-first migration](https://github.com/klum-dsl/klum-ast/wiki/Builder-First-Migration) guidance before resolving a design question.
